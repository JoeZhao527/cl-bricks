...
class BrickClsModule(LightningModule):
    """`BrickClsModule` for Brick Spectrogram classification.
    ...
    def __init__(
        ...
        self.train_acc = F1Score(task="multilabel", num_labels=94, average="macro")
        self.val_acc = F1Score(task="multilabel", num_labels=94, average="macro")
        self.test_acc = F1Score(task="multilabel", num_labels=94, average="macro")
